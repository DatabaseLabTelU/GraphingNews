...
/**
 * @author Isjhar-pc class ini berguna untuk menangani object Node
 */
public class Node {
    ...
    /**
     * Contributor : - isjhar kautsar (isjhar@gmail.com) Constructor yang
     * digunakan melakukan duplikasi object Node
     *
     ...
     * untuk menambahkan 1 buah property ke dalam table hash yang menyimpan
     * daftar property yang dimiliki oleh node IS : properti dengan key yang
     * didefinisikan ada/belum ada FS : properti dengan key yang didefinisikan
     * ditambahkan jika belum ada, dan diperbarui jika sudah ada
     *
    ...
    /**
     * Contributor : - isjhar kautsar (isjhar@gmail.com) method yang digunakan
     * untuk menghapus 1 buah property dari dalam table hash sesuai dengan key
     * yang didefinisikan IS : properti dengan key yang didefinisikan ada/belum
     * ada FS : properti dengan key yang didefinisikan akan dihapus dalam table
     * hash jika ada
     *
    ...
    /**
     * Contributor : - isjhar kautsar (isjhar@gmail.com) method yang digunakan
     * untuk memasukkan edge yang terhubung dengan node ini, ke dalam list edge
     * nya IS : jumlah edge yang ada sebanyak n FS : jumlah edge yang ada
     * sebanyak n + 1
     *
    ...
    /**
     * Contributor : - isjhar kautsar (isjhar@gmail.com) method yang digunakan
     * untuk menghapus edge yang terhubung dengan node ini, dari dalam list edge
     * nya IS : jumlah edge yang ada sebanyak n FS : jumlah edge yang ada
     * sebanyak n - 1
     *
     * @param edge edge yang akan di masukkan
